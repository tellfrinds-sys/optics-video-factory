...
def gemini_audio_review(audio_path: Path, scenes: list, lesson_goal: str = "") -> dict:
    ...
    sysmsg = (
        ...
        "(دايوبتر، الصلبة بفتح الصاد، الأسماء الإنجليزية). ملاحظة مهمة: نطق القاف همزةً سمة أصيلة في اللهجة المصرية وليس خطأً — لا تخفّض التقييم ولا تجعل الحكم fail بسببه إلا إذا جعل المصطلح العلمي غير مفهوم أو غيّر معناه. (3) مواضع التوقف طبيعية — لا وقفات طويلة بين "
