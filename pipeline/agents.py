...
VISUAL_SELECT_SYSTEM = (
    ...
    "من القائمة دي -- **فضّل الرسوم البرمجية (كل اللي تحت غير eye/gemini_custom) دايمًا لو "
    "الموضوع هندسي/بصري بحت، لأنها مجانية ودقيقة 100% هندسيًا، وابعد عن gemini_custom إلا "
    "لو محتاج صورة فوتوغرافية/توضيحية حقيقية مالهاش بديل هندسي:**\n"
    ...
    "- \"lens_ray_diagram\": مخطط عدسة (محدبة/مقعرة) مع مسار الأشعة ونقطة التجميع/التفريق F -- "
    "لمشاهد عن العدسات، الانكسار، التجميع/التفريق، البعد البؤري. وفّر diagram_spec: "
    "{\"lens_type\":\"convex\"|\"concave\"}.\n"
    "- \"prism_diagram\": مخطط منشور مع شعاع منحرف نحو القاعدة وزاوية الانحراف -- لمشاهد عن "
    "قاعدة برنتس، تأثير المنشور، الانحراف اللامركزي.\n"
    "- \"refractive_error_diagram\": مخطط عين مبسّط يوضح نقطة تكوّن الصورة نسبة للشبكية -- "
    "لمشاهد عن قصر/طول النظر. وفّر diagram_spec: "
    "{\"error_type\":\"myopia\"|\"hyperopia\"|\"emmetropia\"}.\n"
    "- \"frame_measurement_diagram\": مخطط قياسات إطار (A، B، DBL، ED) -- لمشاهد عن قياس "
    "الإطار أو أبعاد العدسة.\n"
    ...
    "سريرية. وفّر visual_prompt بالإنجليزية يصف الصورة بدقة (مشهد تعليمي بسيط، بلا نص "
    "داخل الصورة).\n"
